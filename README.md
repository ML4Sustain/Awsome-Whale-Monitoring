...
| 2018 | [Shark Detection from Aerial Imagery Using Region-Based CNN, a Study](http://dx.doi.org/10.1007/978-3-030-03991-2_23) | not specified | bounding box detection |
| 2018 | [A cetacean monitoring system that integrates citizen science and satellite imagery](http://dx.doi.org/10.1007/s12210-017-0657-4) | nan | nan |
| 2019 | [Applying deep learning to right whale photo identification](http://dx.doi.org/10.1007/s42991-022-00253-3) | not specified | biometric estimation<br>individual identification |
...
| 2025 | [Deep learning‑based detection and tracking of fin whales using high‑resolution space‑borne remote sensing data](https://doi.org/10.1016/j.rsase.2025.101580) | NaN - Indian Ocean - fin whale | bounding box tracking |
| 2025 | [Deep learning‑based detection and tracking of fin whales using high‑resolution space‑borne remote sensing data](https://doi.org/10.1016/j.rsase.2025.101580) | NaN - Indian Ocean - fin whale | bounding box detection |
...
| 2025 | [Edge Device Integration to Visualize Blue Whale Tracking Using Space-Borne Remote Sensing Data](http://dx.doi.org/10.1111/maec.70003) | nan | nan |
